...
set_property PACKAGE_PIN T16 [get_ports {sw4_bit_tri_i[3]}]
set_property PACKAGE_PIN W13 [get_ports {sw4_bit_tri_i[2]}]
set_property PACKAGE_PIN P15 [get_ports {sw4_bit_tri_i[1]}]
set_property PACKAGE_PIN G15 [get_ports {sw4_bit_tri_i[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sw4_bit_tri_i[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sw4_bit_tri_i[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sw4_bit_tri_i[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sw4_bit_tri_i[0]}]
